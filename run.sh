...
hyperfine --warmup 1 $1 "bin/run.a data/test_data/cell_e5 -t5"
echo "------- Running 1e5 T 10 ------- "
echo "For Pass 5.3 s (5 300 ms)"
hyperfine --warmup 1 "bin/run.a data/test_data/cell_e5 -t10"
echo "------- Running 1e5 T 20 ------- "
echo "For Pass 2.8 s (2 800 ms)"
hyperfine --warmup 1 "bin/run.a data/test_data/cell_e5 -t20"
